$(document).ready(function() {
	...
	var questions = [
		...
		{name: "Blastoise", question: "Blastoise has two water cannons in its shell, while Mega Blastoise has _____ in its <i>shell</i>.", size: "large", minDamage: 130, maxDamage: 133},
		{name: "Caterpie", question: "The red antenna on Caterpie's head can _____.", size: "x-small", minDamage: 10, maxDamage: 20},
		...
		{name: "Butterfree", question: "Ash's Butterfree fell in love with a _____ Butterfree.", size: "medium", minDamage: 35, maxDamage: 127},
		...
		{name: "Beedrill", question: "Despite having wings, Beedrill is not a Flying type Pokemon but a _____ type Pokemon.", size: "medium", minDamage: 35, maxDamage: 127},
		{name: "Pidgey", question: "Pidgey was originally going to be named _____.", size: "small", minDamage: 25, maxDamage: 35},
		...
		{name: "Pidgeot", question: "Pidgeot DOES NOT have the ability to _____.", size: "x-large", minDamage: 115, maxDamage: 134},
